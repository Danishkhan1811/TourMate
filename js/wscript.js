...
function getWeatherData(city, unit, hourlyorWeek) {
  console.log(city);
  const apiKey = "9YXLZZ676825MZHSRDGMVPLKC";
  fetch(
...
function getIcon(condition) {
	if (condition === "Partly-cloudy-day") {
	  return "../css/images/27.png";
	} else if (condition === "partly-cloudy-night") {
	  return "../css/images/15.png";
	} else if (condition === "rain") {
	  return "../css/images/39.png";
	} else if (condition === "clear-day") {
	  return "../css/images/26.png";
	} else if (condition === "clear-night") {
	  return "../css/images/10.png";
	} else {
	  return "../css/images/26.png";
	}
  }
...
function changeBackground(condition) {
  ...
  let bg = "";
  if (condition === "Partly-cloudy-day") {
    bg = "../css/images/pc.jpg";
  } else if (condition === "partly-cloudy-night") {
    bg = "../css/images/pcn.jpg";
  } else if (condition === "rain") {
    bg = "../css/images/rain.jpg";
  } else if (condition === "clear-day") {
    bg = "../css/images/cd.jpg";
  } else if (condition === "clear-night") {
    bg = "../css/images/cn.jpg";
  } else {
    bg = "../css/images/pc.jpg";
  }
